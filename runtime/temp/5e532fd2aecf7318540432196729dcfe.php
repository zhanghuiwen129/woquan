<?php /*a:2:{s:35:"D:\wwwroot\view\index\visitors.html";i:1770306662;s:38:"D:\wwwroot\view\index\main-layout.html";i:1770774785;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div id="visitors-list" class="space-y-4">
    <?php if(is_array($visitors) || $visitors instanceof \think\Collection || $visitors instanceof \think\Paginator): $i = 0; $__LIST__ = $visitors;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$visitor): $mod = ($i % 2 );++$i;?>
    <div class="visitor-item">
        <a href="/card/<?php echo htmlentities((string) $visitor['visitor_id']); ?>" class="flex items-center gap-3 flex-1">
            <img src="<?php echo htmlentities((string) (isset($visitor['avatar']) && ($visitor['avatar'] !== '')?$visitor['avatar']:'/static/images/default-avatar.png')); ?>" alt="头像" class="visitor-avatar">
            <div class="flex-1">
                <h3 class="font-semibold text-gray-800"><?php echo htmlentities((string) (isset($visitor['nickname']) && ($visitor['nickname'] !== '')?$visitor['nickname']:$visitor['username'])); ?></h3>
                <p class="text-sm text-gray-500 truncate"><?php echo htmlentities((string) (isset($visitor['bio']) && ($visitor['bio'] !== '')?$visitor['bio']:'暂无个性签名')); ?></p>
            </div>
        </a>
        <span class="visitor-time">访问于 <?php echo htmlentities((string) date('Y-m-d H:i',!is_numeric($visitor['visit_time'])? strtotime($visitor['visit_time']) : $visitor['visit_time'])); ?></span>
    </div>
